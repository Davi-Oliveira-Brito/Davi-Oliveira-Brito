...
Right now I'm a Junior Full Stack Developer at [SuccesPar](https://succespar.com.br),
building Django APIs with Python and MySQL, working on WSL, and shipping features
with React and Next.js on the frontend.
...
### Now
- Full stack at [SuccesPar](https://succespar.com.br): Django APIs with Python and MySQL on WSL, React and Next.js on the frontend
...
### What I work with
<p>
  <img src="https://skillicons.dev/icons?i=py,django,cs,dotnet,ts,js,react,nextjs,nodejs,nestjs,html&perline=11" height="36" />
  <img src="https://skillicons.dev/icons?i=css,sass,postgresql,mysql,mongodb,git,github,azure,postman,figma,linux&perline=11" height="36" />
</p>
